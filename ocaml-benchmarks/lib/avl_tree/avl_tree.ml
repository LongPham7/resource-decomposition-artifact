(* This OCaml implementation of the AVL tree comes from this web page:
   https://github.com/aduraj/ocaml-data-structures/blob/master/AVL/avltree.ml/. *)
...
(* Successively insert elements into an AVL tree *)
...
(* We first build an AVL tree by successively inserting the elements of the
